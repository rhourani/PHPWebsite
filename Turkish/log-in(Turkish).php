			...
			<form name="Login">
				<div class="row">
					<div class="col-md-8 well">
						...
						<h3> Lütfen kullanıcı adı ve parolanızı giriniz </h3>
                        <div class="row">    
                            <div class="col-md-5">
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><label><b> Parolanız </b></label></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <br>
						<input type="submit" onclick="#" value="Giriş"/>
		        		...
		        		<div class="row">
		        			<div class="col-md-4">
		        				<div class="alert alert-info">
		        					<a href="#" style="text-decoration: underline;"> Ziyaretçi olarak devam et </a>
		        				</div>
		        			</div>
		        			<div class="col-md-4">
		        				<div class="alert alert-danger">
		        					<span class="psw">Parolanızı <a href="#" style="text-decoration: underline;">Unuttunuz Mu?</a></span>
		        				</div>
		        			</div>
		        		</div>
					</div>
