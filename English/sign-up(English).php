			...
			<form name="Sign-up">
				<div class="row">
					<div class="col-md-8 well">
						...
						<h3> When You Sign-up You Can Comment On Our Puplishers </h3>
						<div class="row">
							<div class="col-md-5">
								<table>
									<tbody>
										...
										<tr>
											<td><label><b> Write your Password again, Please!</b></label></td>
										</tr>
									</tbody>
								</table>
							</div>
						...
						<br>
						<input type="submit" onclick="check(this.form)" value="Sign-up"/>
